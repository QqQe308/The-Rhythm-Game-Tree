...
<h3>v0.09 REBALANCE 2023/10/18~2023/10/20<br>
- 添加1个层级：Lanota<br>
- 添加“PTT”，包括3个可点击<br>
- 添加“RKS”，包括1个可点击<br>
- 添加6+3+5+1=15个升级，3+1+2=6个里程碑<br>
- 重新制作了游戏（修改很多升级，重新平衡）<br>
- 游戏结局：1e30000 Notes（1e18 Phidata，1e175源点）<br>
...
let winText = `恭喜通关！你已经完成了你的音游之旅…吗？请期待下一个更新！<br>当前结局：1e30000 Notes，下一个更新:！`

// Determines when the game "ends"
function isEndgame() {
	return player.points.gte(new Decimal("1e30000"))
}
