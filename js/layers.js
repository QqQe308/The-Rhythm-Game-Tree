 ...
 passiveGeneration()
  ...
  doReset(resettingLayer) {
    ...
    12:{ title: "游戏可真<困难>",
                ...
                effect() {
             return player.s.points.add(1).pow(6).min(new Decimal('1e15000'))
                },
     effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"×" }, },
    13:{ title: "这游戏不要太“简单”？？",
    ...
    14:{ title: "不需要的升级",
                ...
                effect() {
        return player.s.points.add(1).pow(4).min(new Decimal('1e10000'))
        },
 effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"×" }, },
    15:{ title: "这游戏就这点内容吗？",
...
addLayer("t", {
    ...
    row: 3, 
    hotkeys: [
        {key: "m", description: "M: Reset for Monster Songs", },
    ],
